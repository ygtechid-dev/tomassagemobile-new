...
const TambalBan = ({ navigation }) => {
  ...
  const handleSave = async () => {
    try {
      ...
      const message = "Halo, Kami dari Ladju Repair. Permintaan Tambal Ban anda berhasil. Silahkan ditunggu tim kami akan menghubungi anda sesaat lagi.";
  ...
  return (
    <ScrollView style={styles.container}>
      <TouchableOpacity onPress={() => navigation.goBack()} style={{ flexDirection: 'row' }}>
        ...
        <Text style={styles.txtDesc}>Tambal Ban | LadjuRepair.</Text>
      </TouchableOpacity>
...
{/* <Text style={styles.label}>Keluhan:</Text>
        ...
        <Text style={styles.label}>Tanggal Tambal:</Text>
