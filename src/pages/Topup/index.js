    ...
    <View style={styles.container}>
      ...
      <ImageBackground source={BackGS} style={{ height: 200 }}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Topup Saldo</Text>
      ...
      <TouchableOpacity style={styles.containerCard} onPress={() => navigation.push('RetailPaymentScreen', {
      userData: userData
    })}>
      <View style={styles.iconContainer}>
        <Icon name="bank" size={24} color="#1EAAA6" />
      </View>
      <Text style={styles.title}>{"Alfamart / Indomaret"}</Text>
      <Icon name="chevron-right" size={24} color="#A0A0A0" />
    </TouchableOpacity>
    <TouchableOpacity style={styles.containerCard} onPress={() => navigation.push('TopupQRIS', {
      userData: userData
    })}>
      <View style={styles.iconContainer}>
