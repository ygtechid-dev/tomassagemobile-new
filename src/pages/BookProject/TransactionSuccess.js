  ...
  return (
    <ImageBackground source={BackGS} style={styles.container}>
      ...
      <Card style={styles.card}>
        ...
        <Text style={styles.subText}>Alhamdulillah, Anda sudah melakukan investasi</Text>
        <Text style={styles.amount}>Rp 10.000.000</Text>

        <Divider style={{marginTop: 16, marginBottom: 16}}/>
        
        <View style={styles.projectContainer}>
          <Text style={styles.projectText}>Project #4353</Text>
          <View style={styles.productContainer}>
            <Image
              source={{ uri: "https://ygtechdev.my.id/files/photo-1739937156596-623490198.png" }}
