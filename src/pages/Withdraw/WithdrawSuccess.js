  ...
  return (
    <ImageBackground source={BackGS} style={styles.container}>
      ...
      <Card style={styles.card}>
        ...
        <Text style={styles.successText}>Tarik Dana Berhasil!</Text>
        <Text style={styles.subText}>Alhamdulillah , Proses Tarik Dana Berhasil!</Text>
        ...
        <View style={styles.projectContainer}>
          ...
          <View style={styles.productContainer}>
            ...
            <View style={styles.productInfo}>
              <Text style={styles.productTitle}>Rebecca Copper</Text>
              <Text style={styles.productDetails}>BSI 834324234 • 15:12</Text>
            </View>
          </View>
