...
const VerifPageCust = ({navigation}) => {
  return (
    <ImageBackground source={BGgs} style={styles.background}>
        ...
        <TouchableOpacity onPress={() => navigation.push('HomePageCust')} style={{backgroundColor: 'white', height: 70, width: '90%', borderRadius: 20, flexDirection: 'row', justifyContent: 'space-between'}}>
