...
const InvestasiReport = ({navigation}) => {
    ...
    <View style={styles.container}>
      ...
      <ImageBackground source={BackGS} style={{ height: 200 }}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Laporan Investasi</Text>
      ...
      <View style={{ alignItems: "center", marginBottom: 20 }}>
        <Text style={{ fontSize: 28, fontWeight: "bold", color: "#4AB19D" }}>
          Rp10.000.000
        </Text>
        <Text style={{ fontSize: 14, color: "#6B7280" }}>
          Profit anda <Text style={{ color: "#4AB19D", fontWeight: "bold", fontSize: 14 }}>Rp1.000.000</Text> di Bulan Januari
        </Text>
      </View>
      ...
      <View style={{ borderBottomWidth: 1, borderBottomColor: "#E5E7EB", paddingBottom: 10 }}>
        ...
        <Text style={{ color: "#6B7280", fontSize: 14 }}>2 Dec 2020 • 3:09 PM</Text>
        <Text style={{ fontSize: 18, fontWeight: "bold", color: "#4AB19D", alignSelf: "flex-end", marginTop: -20 }}>
          +Rp 11.000.000
        </Text>
      </View>
...
export default InvestasiReport;
