...
const PengajuanSuccess = ({navigation}) => {
  return (
    <ImageBackground source={BackGS} style={styles.container}>
      ...
      <Card style={styles.card}>
        ...
        <Text style={styles.successText}>Pengajuan Berhasil!</Text>
        <Text style={styles.subText}>Anda akan mendapatkan informasi dalam 2 Hari Kerja</Text>
        ...
        {/* <View style={styles.projectContainer}>
          ...
          <View style={styles.productContainer}>
            <Image
              source={{ uri: "http://jnt.hi-guard.id/files/photo-1739952525094-456252774.png" }}
              style={styles.productImage}
            />
            <View style={styles.productInfo}>
              <Text style={styles.productTitle}>Saldo Berkaniaga</Text>
        ...
        <TouchableOpacity style={styles.button} onPress={() => navigation.push('HomePageCust')}>
...
export default PengajuanSuccess;
